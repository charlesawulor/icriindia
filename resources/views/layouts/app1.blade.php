...
<footer>
	<div class="container">
		...
		<div class="footer_cata_option d-flex">
			<a class="catag" href="#">Jagannath University</a>
			<a class="catag" href="#">Ansal University</a>
			<a class="catag" href="#">Education Loan</a>
			<a class="catag" href="#">Jaipur National University</a>
			<a class="catag" href="#">FAQs</a>
			<a class="catag" href="#">VLE Login</a>
			<a class="catag" href="#">Wipro Employee Access Only</a>
			<a class="catag" href="#">Pay Online</a>
			<a class="catag" href="#">Newsletter</a>
			<a class="catag" href="#">E-Books</a>
		</div>
