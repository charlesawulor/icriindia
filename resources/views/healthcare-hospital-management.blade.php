...
<div class="container">
    ...
    @if(count($healthcarehospitalmanagements) > 0)	
	@foreach($healthcarehospitalmanagements as $healthcarehospitalmanagement)
			<span>{{$healthcarehospitalmanagement->course_title}}</span>
            @endforeach
            @endif
		</div>
	...
	<div class="container d-flex">
		<ul class="nav nav-tabs" id="myTab" role="tablist">
		  <li class="nav-item col-lg-3 col-sm-3 col-3">
		    <a class="nav-link active" id="tab_ci" data-toggle="tab" href="#tab_ci_tag" role="tab" aria-controls="tab_ci_tag" aria-selected="true">Healthcare & Hospital Management<br>INDUSTRY<span></span></a>
		  </li>
		  <li class="nav-item col-lg-5 col-sm-5 col-5">
		    <a class="nav-link" id="tab_wdpcr" data-toggle="tab" href="#tab_wdpcr_tag" role="tab" aria-controls="tab_wdpcr_tag" aria-selected="false">WHY DEGREE PROGRAMS IN Healthcare & Hospital Management<span></span></a>
		  </li>
	...
	@foreach($healthcarehospitalmanagements as $healthcarehospitalmanagement)
				<div class="row">
					<div class="col-lg-6 col-sm-6">
						...
						{{$healthcarehospitalmanagement->about_course}}

						</div>
					</div>
			
					<div class="col-lg-6 col-sm-3 col-sm-6">
						<img src="/icriindia/storage/app/public/{{$healthcarehospitalmanagement->image}}" width="100%" class="cr_cli_re_cont">
					</div>
				</div>
              @endforeach
     @endif
				...
				<div class="row">
					<div class="col-lg-12 col-sm-12">
						<div class="cr_sec_disc">
                            ...
                            @if(count($whyhealthcarehospitalmanagements) > 0)	
	@foreach($whyhealthcarehospitalmanagements as $whyhealthcarehospitalmanagement)
								<li><span>{{$whyhealthcarehospitalmanagement->why_healthcarehospital}}</span></li>
                                    @endforeach
                                    @endif
				...
				<div class="row">
					<div class="col-lg-12 col-sm-12">
						<div class="cr_sec_disc">
                            ...
                            @if(count($deliverableshealthcarehospitalmanagements) > 0)	
	@foreach($deliverableshealthcarehospitalmanagements as $deliverableshealthcarehospitalmanagement)
								<li><span>{{$deliverableshealthcarehospitalmanagement->deliverables}}</span></li>
                                    @endforeach
                                    @endif
	...
	<div class="container d-flex">
		<div class="row">
			...
			<div class="col-lg-6">
                ...
                @if(count($whyicrihealthcarehospitalmanagements) > 0)	
	@foreach($whyicrihealthcarehospitalmanagements as $whyicrihealthcarehospitalmanagement)
					<div class="cr_why_icri_text_cont position-relative">{{$whyicrihealthcarehospitalmanagement->why_icri_health}}</div>
                @endforeach
            @endif
				</div>
			</div>
		...
		<div class="tab-pane fade show active" id="tab_one_tag" role="tabpanel" aria-labelledby="tab_one">
		  	...
		  	<div class="ctm-tab-cont">
			  	<div class="row offer_tab_cont_row">
			  		<div class="col_auto_set">
			  			<div class="offer_tab_cont_disc offer_tab_cont_disc_head">MSc <span>Healthcare & Hospital Management</span></div>
